...
# class Team:
#
#     def getMinRuns(self,p):
#         min_score_index = p[0].playerScore
#         min=0
#         for i in p:
#             if i.playerScore < min_score_index:
#                 min= i
#                 min_score_index=i.playerScore
#         print(min.playerName, min.playerCountry,min.playerScore)
#
#     def getMaxWickets(self,p):
#         max_wicket_index=0
#         for i in range(1,len(p)):
#             if p[i].Wicket>p[max_wicket_index].Wicket:
#                 max_wicket_index=i
