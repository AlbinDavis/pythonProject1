...
def longestSubstrDistinctChars(string="aewergrththy"):
    seen = {}
    maximum_length = 0
...
def wordPattern(p="abba", s="dog cat cat fish"):
    st = set()
    s = s.split(" ")
    if (len(s) != len(p)):
        return False
...
def Minimum_Index_Sum_of_Two_Lists(list1=["Shogun", "Tapioca Express", "Burger King", "KFC"],
